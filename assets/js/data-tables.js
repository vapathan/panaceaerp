...
var dataSet = [
    ...
    [ "110" , "<img src='../../assets/img/dashboard/rakhan-potik-1.jpg' style='width:50px; height:30px;'> Anny", "anny@123gmail.com",  "2321","Low Rider", "2020/05/03", ],
    ...
    [ "120" , "<img src='../../assets/img/dashboard/rakhan-potik-2.jpg' style='width:50px; height:30px;'> Anny", "anny@123gmail.com",  "2321","Low Rider", "2020/05/03", ],
  ...
  var dataSet1 = [
      ...
      [ "110" , "<img src='../../assets/img/dashboard/rakhan-potik-2.jpg' style='width:50px; height:30px;'> Anny", "anny@123gmail.com",  "2321", "2020/05/03","<a href='#'><i class='fas fa-paper-plane ms-text-primary'></i> <i class='far fa-trash-alt ms-text-danger'></i></a>" ],
      ...
      [ "120" , "<img src='../../assets/img/dashboard/rakhan-potik-4.jpg' style='width:50px; height:30px;'> Anny", "anny@123gmail.com",  "2321", "2020/05/03","<a href='#'><i class='fas fa-paper-plane ms-text-primary'></i><i class='far fa-trash-alt ms-text-danger'></i></a>" ],
    ...
    var dataSet2 = [
        ...
        [ "110" , "<img src='../../assets/img/dashboard/product-1.jpg' style='width:50px; height:30px;'> Low Rider",   "2321", "2020/05/03","2","$350.50" ,"<span class='badge badge-primary'>Paid</span>","<a href='#'> <i class='fas fa-paper-plane ms-text-primary'></i><i class='far fa-trash-alt ms-text-danger'></i></a>"],
      ...
      var dataSet3 = [
        ...
        var dataSet4= [
          ["101" , "<img src='../../assets/img/dashboard/product-1.jpg' style='width:50px; height:30px;'> Low Rider","$620.50", "2020/05/03","2","<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i> <i class='far fa-trash-alt ms-text-danger'></i></a>"],
          [ "102" , "<img src='../../assets/img/dashboard/product-2.jpg' style='width:50px; height:30px;'> Hemp Oil","$450.50", "2020/05/03","3","<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i> <i class='far fa-trash-alt ms-text-danger'></i></a>"],
          ...
          ["105" , "<img src='../../assets/img/dashboard/product-1.jpg' style='width:50px; height:30px;'> Low Rider","$320.50", "2020/05/03","1","<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i> <i class='far fa-trash-alt ms-text-danger'></i></a>"],
          ...
          [ "106" , "<img src='../../assets/img/dashboard/product-3.jpg' style='width:50px; height:30px;'> Hemp Oil","$520.50", "2020/05/03","3","<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i> <i class='far fa-trash-alt ms-text-danger'></i></a>"],
          ...
          ["109" , "<img src='../../assets/img/dashboard/product-3.jpg' style='width:50px; height:30px;'> Low Rider","$220.50", "2020/05/03","4","<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i> <i class='far fa-trash-alt ms-text-danger'></i></a>"],
          [ "110" , "<img src='../../assets/img/dashboard/product-1.jpg' style='width:50px; height:30px;'> Hemp Oil","$720.50", "2020/05/03","3","<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i> <i class='far fa-trash-alt ms-text-danger'></i></a>"],
          ["111" , "<img src='../../assets/img/dashboard/product-2.jpg' style='width:50px; height:30px;'> Low Rider","$620.50", "2020/05/03","1","<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i> <i class='far fa-trash-alt ms-text-danger'></i></a>"],
          [ "112" , "<img src='../../assets/img/dashboard/product-3.jpg' style='width:50px; height:30px;'> Hemp Oil","$450.50", "2020/05/03","6","<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i> <i class='far fa-trash-alt ms-text-danger'></i></a>"],
          ...
          ["115" , "<img src='../../assets/img/dashboard/product-3.jpg' style='width:50px; height:30px;'> Low Rider","$320.50", "2020/05/03","2","<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i> <i class='far fa-trash-alt ms-text-danger'></i></a>"],
          [ "116" , "<img src='../../assets/img/dashboard/product-1.jpg' style='width:50px; height:30px;'>Hemp Oil","$520.50", "2020/05/03","3","<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i> <i class='far fa-trash-alt ms-text-danger'></i></a>"],
          ...
          ["119" , "<img src='../../assets/img/dashboard/product-1.jpg' style='width:50px; height:30px;'> Low Rider","$220.50", "2020/05/03","4","<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i> <i class='far fa-trash-alt ms-text-danger'></i></a>"],
          [ "120" , "<img src='../../assets/img/dashboard/product-2.jpg' style='width:50px; height:30px;'>Hemp Oil","$720.50", "2020/05/03","3","<a href='#'><i class='fas fa-pencil-alt ms-text-primary'></i> <i class='far fa-trash-alt ms-text-danger'></i></a>"],
          ...
          var dataSet5 = [
            ...
            var dataSet6 = [
                ...
                [ "110" , "<img src='../../assets/img/dashboard/product-1.jpg' style='width:50px; height:30px;'>Low Rider","Wrong Product", "2011/04/25", "2011/04/25", "2020/05/03", "<a href='#'><i class='far fa-trash-alt ms-text-danger ml-3'></i></a>"],
