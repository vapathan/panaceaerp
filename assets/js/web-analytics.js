(function($) {
  ...
  gradientStrokePrimary.addColorStop(0, '#268968');

  var gradientFillPrimary = audienceMetricsCtx.createLinearGradient(0, 0, 0, 450);
  gradientFillPrimary.addColorStop(0, "rgba(38,137,104,0.4)");
  ...
  gradientStrokePrimaryDanger.addColorStop(0, '#ea6e27');

  var gradientFillPrimaryDanger = audienceMetricsCtx.createLinearGradient(0, 0, 0, 450);
  gradientFillPrimaryDanger.addColorStop(0, "rgba(234, 110, 39,0.4)");
  ...
  gradientStrokebounceRate.addColorStop(0, '#268968');

  var gradientFillbounceRate = bounceRateCtx.createLinearGradient(0, 0, 0, 450);
  gradientFillbounceRate.addColorStop(0, "rgba(38, 137, 104,0.3)");
  ...
  gradientStrokepageViews.addColorStop(0, '#ea6e27');

  var gradientFillpageViews = pageViewsCtx.createLinearGradient(0, 0, 0, 450);
  gradientFillpageViews.addColorStop(0, "rgba(234, 110, 39,0.4)");
  ...
  gradientStrokenewSessions.addColorStop(0, '#ea6e27');

  var gradientFillnewSessions = newSessionsCtx.createLinearGradient(0, 0, 0, 450);
  gradientFillnewSessions.addColorStop(0, "rgba(234, 110, 39,0.4)");
  ...
  gradientStroketimeSite.addColorStop(0, '#268968');

  var gradientFilltimeSite = timeSiteCtx.createLinearGradient(0, 0, 0, 450);
  gradientFilltimeSite.addColorStop(0, "rgba(38, 137, 104,0.3)");
  ...
  gradientStrokesiteImpressions.addColorStop(0, '#268968');

  var gradientFillsiteImpressions = siteImpressionsCtx.createLinearGradient(0, 0, 0, 450);
  gradientFillsiteImpressions.addColorStop(0, "rgba(38, 137, 104,0.3)");
