(function($) {
  ...
  new Chart(document.getElementById("pie-chart"), {
    ...
    data: {
      ...
      datasets: [{
        ...
        backgroundColor: ["#268968", "#ea6e27","#769e26","#4e5125","#3e4f3c"],
  ...
  gradientStroke.addColorStop(0, '#268968');

  var gradientFill = ctx.createLinearGradient(0, 0, 0, 450);
  gradientFill.addColorStop(0, "rgba(38,137,104,0.4)");
  ...
  gradientStrokeengagedUsers.addColorStop(0, '#268968');

  var gradientFillengagedUsers = engagedUsersCtx.createLinearGradient(0, 0, 0, 450);
  gradientFillengagedUsers.addColorStop(0, "rgba(38, 137, 104,0.3)");
  ...
  gradientStrokepageImpressions.addColorStop(0, '#268968');

  var gradientFillpageImpressions = pageImpressionsCtx.createLinearGradient(0, 0, 0, 450);
  gradientFillpageImpressions.addColorStop(0, "rgba(38, 137, 104,0.3)");
